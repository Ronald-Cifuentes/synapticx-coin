...
- **Validación fuerte**: autorización real (hash(secret)==owner_secret_hash); amount/asset desde estado; coinbase según política; difficulty fijada contra policy; merkle root recomputado
